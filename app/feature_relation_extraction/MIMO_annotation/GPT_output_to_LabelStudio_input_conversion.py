...
# print(environ.get('CORENLP_HOME'))
...
"""  
ATRA 1 micromol/L can up-regulate the expression of HOXA9 mRNA and protein in HL-60 cells.
{'fact_tuples': [['atra',
   '1 micromol/l',
   'can up-regulate',
   'hoxa9',
   'expression']],
 'condition_tuples': [['hoxa9', 'expression', 'in', 'hl-60 cells', '']]}
"""
...
client.start()
sleep(5)
""" Starting server with command: java -Xmx4G -cp /Users/qingyangf/Desktop/MetaNovas/corenlp/stanford-corenlp-4.5.5/* edu.stanford.nlp.pipeline.StanfordCoreNLPServer -port 9001 -timeout 60000 -threads 5 -maxCharLength 100000 -quiet True -serverProperties corenlp_server-f3907ac2af78498a.props -preload tokenize,mwt,pos,lemma,depparse
 """
