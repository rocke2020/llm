...
class ArgparseUtil(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--model_performence_dir_in_prediction", type=str, default='', help="save the model performence in prediction mode on test dataset, without configurations, for temp check")
    ...
    def peptimizer(self):
        ...
        self.parser.add_argument("--enable_train", type=int, default=0, help="0 false, 1 true")
    ...
    def classifier_rnn(self):
        ...
        self.parser.add_argument("--enable_train", type=int, default=1, help="0 false, 1 true")
        ...
        self.parser.add_argument("--dropout", type=float, default=0.5, help="")
        self.parser.add_argument("--use_fixed_hyparameter", type=int, default=1, help="0 false, 1 true")
        self.parser.add_argument("--overwrite_hyperparameter_dict", type=int, default=0, help="0 false, 1 true")
    ...
    def classifier_cnn_rnn(self):
        ...
        self.parser.add_argument(
            "--category_column_name", type=str, default='activity', 
            help="category_column_name")
        self.parser.add_argument(
            "--enable_train", type=int, default=1, help="0 false, 1 true")
        self.parser.add_argument(
            "--embedding_type", type=str, default='', help="vocab, esm, t5")
        self.parser.add_argument(
            "--read_dataset_cache", type=int, default=1, help="0 false, overwite; 1 true")
        ...
        self.parser.add_argument(
            "--use_fixed_hyparameter", type=int, default=1, help="0 false, 1 true")
        self.parser.add_argument(
            "--overwrite_hyperparameter_dict", type=int, default=0, help="0 false, 1 true")
        args = self.parser.parse_args()
        return args
    ...
    def generator_rnn(self):
        ...
        self.parser.add_argument("--enable_train", type=int, default=1, help="0 false, 1 true")
        self.parser.add_argument("--embedding_type", type=str, default='vocab', help="vocab, esm, t5")
        self.parser.add_argument("--only_positive", type=int, default=1,
            help="Generator train/test only need positive samples")
        self.parser.add_argument("--read_dataset_cache", type=int, default=1, help="0 is false, overwite; 1 true")
        self.parser.add_argument("--basic_model", type=str, default='lstm', help="NB: gru for acne generator")
        ...
        self.parser.add_argument("--sample_batch_size", type=int, default=10_000, help="")
    ...
    def classifier_transformer_rnn(self):
        ...
        self.parser.add_argument("--use_rnn", type=int, default=0, help="0 false, 1 true")
